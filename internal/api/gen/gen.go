...
// oapi-codegen. The generated file (forge.gen.go) is committed; never edit it
...
//go:generate go run github.com/rotemmiz/forge/internal/tools/downconvert -in ../../../conformance/openapi-reference.json -out openapi-3.0.derived.json
