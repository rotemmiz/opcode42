...
open class Opcode42ClientAPIConfiguration: @unchecked Sendable {
    ...
    public static let shared = Opcode42ClientAPIConfiguration()
}
...
open class RequestBuilder<T>: @unchecked Sendable {
    ...
    public let apiConfiguration: Opcode42ClientAPIConfiguration

    /// Optional block to obtain a reference to the request's progress instance when available.
    public var onProgressReady: ((Progress) -> Void)?

    required public init(method: String, URLString: String, parameters: [String: Any]?, headers: [String: String] = [:], requiresAuthentication: Bool, apiConfiguration: Opcode42ClientAPIConfiguration = Opcode42ClientAPIConfiguration.shared) {
        self.method = method
